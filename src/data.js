...
export const MATERIALS_GUIDE = [
  {
    ...
    warmthPercent: 95,
    description:
      'Harvested exclusively from the underbelly of high-altitude Himalayan mountain goats. Unrivalled insulation despite being almost weightless.',
  ...
  },
  {
    ...
    warmthPercent: 100,
    description:
      'The finest natural animal fiber known to mankind. King of weaves with supreme thermal density that easily passes through a small ring.',
  ...
  },
  {
    ...
    warmthPercent: 90,
    description:
      'Spun from hardy mountain sheep wool in Swat Valley. Famous for its thick density, weather resistance, and ornate border weaves.',
  ...
  },
  {
    ...
    warmthPercent: 75,
    description:
      'A blend of raw Chinese/Kashmiri silk with Australian extrafine merino. Radiant in low light with a flowing silhouette.',
...
export const CRAFT_DETAILED_STEPS = [
  {
    ...
    details: [
      'Hand-combed during natural moulting season',
      'Zero synthetic polyester or nylon blending',
      'Cruelty-free ethical mountain sourcing',
    ],
  },
  {
    number: '02',
    ...
    details: [
      'Preserves natural air pockets between fibers',
      'Gentle yarn tension prevents breakage',
      'Traditional wooden wheel craftsmanship',
    ],
  },
  {
    number: '03',
    ...
    details: [
      'Intricate Boteh (paisley) and Zari borders',
      'High warp-to-weft thread count',
      'Distinctive organic handloom selvage edge',
    ],
  },
  {
    number: '04',
    ...
    details: [
      'Colorfast, non-fading hues',
      'Chemical-free gentle treatment',
      'Rich, deep organic color tones',
    ],
  },
  {
    number: '05',
    ...
    details: [
      'Hand-rolled and knotted fringes',
      'Optional Sozni & Tilla needlework',
      'Clean, refined reverse-side finish',
    ],
  },
  {
    number: '06',
